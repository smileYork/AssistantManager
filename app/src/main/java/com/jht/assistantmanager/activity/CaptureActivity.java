...
public class CaptureActivity extends Activity implements Callback {
    ...
    private void openActivity(String cardNumber) {
        ...
        if (fromType == 0) {
            ...
            intent.setClass(mContext, CardSearchResultActivity.class);

        } else if (fromType == 1) {

            intent.setClass(mContext, CardGiveActivity.class);

        } else {

            intent.setClass(mContext, CardSaleActivity.class);
        }
