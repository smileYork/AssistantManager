...
import com.jht.assistantmanager.adapter.ListForOrderAdapter;
...
public class OrderListActivity extends Activity {
	...
	private ListForOrderAdapter listAdapet;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getOrderList(time_type, j * PAGE_SIZE);
	...
	private void getOrderList(int time, int first) {
		try {
	...
	private void initRequestInfo(int time, int first) throws JSONException {
		...
		object.put("startnum", first * PAGE_SIZE);
	...
	private void initView() {
		...
		listAdapet = new ListForOrderAdapter(mContext, list);
	...
	private void getCardInfo() {
		...
		try {
			...
			if (NetWorkJudgeUtil.isConnect(mContext)) {
				...
				initRequestInfo(time_type, j);

				GlobalData.post(GlobalData.Card_Search_Order_Url, object.toString(), callBack);
