package com.jht.assistantmanager.view;
...
import com.jht.assistantmanager.model.GesturePoint;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (pointAt == null || currentPoint.equals(pointAt)
					|| Constants.POINT_STATE_SELECTED == pointAt.getPointState()) {
		...
		case MotionEvent.ACTION_UP:
			if (isVerify) {
				...
				if (passWord.equals(PasswordUtil.getMd5ByString(passWordSb.toString()))) {
